...
public:
    ImageGrabber(ORB_SLAM3::System* pSLAM):
        ...
        Node("RGBD")
        {
            message_filters::Subscriber<sensor_msgs::msg::Image> left_sub(this, "/camera/left/image_raw");
            message_filters::Subscriber<sensor_msgs::msg::Image> right_sub(this, "/camera/right/image_raw");
