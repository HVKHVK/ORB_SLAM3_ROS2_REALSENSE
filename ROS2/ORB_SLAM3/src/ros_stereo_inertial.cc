...
public:
    ...
    mbClahe(bClahe)
    {
      ...
      sub_img_left = this->create_subscription<sensor_msgs::msg::Image>("/camera/left/image_raw", 100, std::bind(&ImageGrabber::GrabImageLeft, this, std::placeholders::_1));
      sub_img_right = this->create_subscription<sensor_msgs::msg::Image>("/camera/right/image_raw", 100, std::bind(&ImageGrabber::GrabImageRight, this, std::placeholders::_1));
    }
    ...
    queue<sensor_msgs::msg::Image::ConstPtr> imgLeftBuf, imgRightBuf;
...
int main(int argc, char **argv)
{
  ...
  auto node = std::make_shared<ImageGrabber>(&SLAM,sbRect == "true", &bEqual);
